...
public class ListIterator<E> {
     ...
     * 
     * @param e
     *            the list element that the iterator starts at.
     */
    ...
    /**
     * Returns the element that this iterator is positioned on, and advances the
     * iterator to the next element. Should be called only if hasNext() is true.
     * 
